...
For this laboratory work, I used ChatGPT as an assistant.
...
All token measurements and API results used in the report were obtained by running the laboratory scripts on my own computer. I ran Parts 0 and 1 locally and used my own Anthropic API access for Part 2. The annual cost figures were calculated using the provided Part 3 script.
